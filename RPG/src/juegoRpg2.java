                    ...
                    switch (opcion) {
                        case 1:
                            ...
                            if (attackP1.equalsIgnoreCase("normal")) {
                                ...
                                System.out.println("Haz hecho un ataque normal de " + dañoReal);
                                ...
                                System.out.println("Haz hecho un ataque critico de " + dañocritico);
                            }
...
//                            System.out.println(i+") "+inventario[i]);
                            ...
                            if (pocion.equalsIgnoreCase("Si")) {
                                ...
                                if (inventario[posicionInventario].equalsIgnoreCase("Pocion de vida")) {
                                    ...
                                    System.out.println("Has tomado una " + inventario[posicionInventario]);
                                    System.out.println("Multiplicador de daño actual: " + multiplicadordaño);
                                    inventario[posicionInventario] = null;
                                }
